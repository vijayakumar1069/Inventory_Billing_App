...
const signupRouter = async (req, res, next) => {
  ...
  try {
    ...
    const verificationLink = `https://master--creative-medovik-389af4.netlify.app/verify/${addnewadmin._id}/${verificationToken}`;
...
const loginRouter = async (req, res, next) => {
  try {
    ...
    if (findadminexists.isVerified == false) {
      const verificationLink = `https://master--creative-medovik-389af4.netlify.app/verify/${findadminexists._id}/${findadminexists.verificationToken}`;
...
const reset_password = async (req, res, next) => {
  try {
    ...
    const resetLink = `https://master--creative-medovik-389af4.netlify.app/reset-password/${user._id}/${resetToken}`;
